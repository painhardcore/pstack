...
3. Plan the fix from the trace. If it crosses a function boundary, run **architect** first. Delegate with a specific scope when subagents are available and permitted. Otherwise implement inline. Review the diff and capture a post-fix trace.
