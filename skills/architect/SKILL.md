...
Inherit the parent model unless the host supports model selection. When it does, prefer distinct available model families for the candidate sketches. If subagents are unavailable or forbidden, sketch at least two distinct designs inline before synthesis.
