...
**Why:** Symptom fixes accumulate. Each workaround makes the system harder to reason about without fixing the bug. Root-cause fixes are slower upfront but reduce total debugging time.
